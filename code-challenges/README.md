...
When you finish the assignment each day, make a new pull request from your daily challenge branch to your master branch and submit the PR URL in Canvas. You can always submit a link to a pull request even if the pull request is closed.

### Collaboration and Resources
Working together with Marie, Garfield and Kassie